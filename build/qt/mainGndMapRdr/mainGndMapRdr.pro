# mainGndMapRdr OpenEaaglesExample
include(../config.pri)

# our root
MY_ROOT = $$HOME_ROOT/mainGndMapRdr
...
win32:CONFIG(release, debug|release): LIBS +=           \
    ...
    -loeBasicGL -loeBasic                           \
    -loeGlut                                          \
    -loeSimulation -loeDafif -loeTerrain          \
    # oe 3rd party
...
# Windows (MSVC) Debug libraries
    ...
    -loeGlut_d                                          \
    -loeSimulation_d -loeDafif_d -loeTerrain_d          \
    # oe 3rd party
    -L$${OE_3RD_PARTY_ROOT}/lib/$${MSVC_VER}-32/        \
...
# Linux libraries
    ...
    -loeBasicGL -loeBasic                           \
    -loeGlut                                        \
    -loeSimulation -loeTerrain -loeDafif \
    # oe 3rd party
