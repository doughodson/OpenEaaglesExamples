...
win32:CONFIG(release, debug|release): LIBS +=           \
    ...
    -loeBasicGL -loeBasic -loeInstruments         \
    -loeGlut                                          \
    -loeDis -loeSensors -loeSimulation            \
    -loeDafif                                         \
    -loeOtw                                           \
    # oe 3rd party
...
# Windows (MSVC) Debug libraries
    ...
    # open eaagles
    -L$${OE_ROOT}/lib/$${MSVC_VER}/                     \
    -loeBasicGL_d -loeBasic_d -loeInstruments_d         \
    -loeGlut_d                                          \
    -loeDis_d -loeSensors_d -loeSimulation_d            \
    -loeDafif_d                                         \
    -loeOtw_d                                           \
    # oe 3rd party
    -L$${OE_3RD_PARTY_ROOT}/lib/$${MSVC_VER}-32/        \
