...
bool DataRecorder::recordMyData(const Basic::Object* objs[4], const double values[4])
{
   ...
   myDataMsg->set_fee( (unsigned int) Eaagles::nintd(values[0]) );
   myDataMsg->set_fi( (unsigned int) Eaagles::nintd(values[1]) );
   myDataMsg->set_fo( (unsigned int) Eaagles::nintd(values[2]) );
...
bool DataRecorder::recordMarker(const Basic::Object* objs[4], const double values[4])
{
   ...
   // Extended value: foo
   markerMsg->SetExtension( Pb::foo, (unsigned int) Eaagles::nintd(values[2]) ) ;
