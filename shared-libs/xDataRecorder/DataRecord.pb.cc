...
void protobuf_AssignDesc_xDataRecorder_2fDataRecord_2eproto() {
  protobuf_AddDesc_xDataRecorder_2fDataRecord_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "xDataRecorder/DataRecord.proto");
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_xDataRecorder_2fDataRecord_2eproto);
}
...
void protobuf_ShutdownFile_xDataRecorder_2fDataRecord_2eproto() {
  delete MyDataMsg::default_instance_;
  delete MyDataMsg_reflection_;
}

void protobuf_AddDesc_xDataRecorder_2fDataRecord_2eproto() {
  static bool already_here = false;
  if (already_here) return;
  already_here = true;
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  ::Eaagles::Recorder::Pb::protobuf_AddDesc_openeaagles_2frecorder_2fDataRecord_2eproto();
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\036xDataRecorder/DataRecord.proto\022\030Eaagle"
    "s.xDataRecorder.Pb\032%openeaagles/recorder"
    "/DataRecord.proto\"0\n\tMyDataMsg\022\013\n\003fee\030\001 "
    "\002(\r\022\n\n\002fi\030\002 \002(\r\022\n\n\002fo\030\003 \002(\r:Z\n\013my_data_m"
    "sg\022\037.Eaagles.Recorder.Pb.DataRecord\030\350\007 \001"
    "(\0132#.Eaagles.xDataRecorder.Pb.MyDataMsg:"
    "+\n\003foo\022\036.Eaagles.Recorder.Pb.MarkerMsg\030d"
    " \001(\r", 284);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "xDataRecorder/DataRecord.proto", &protobuf_RegisterTypes);
  MyDataMsg::default_instance_ = new MyDataMsg();
  ::google::protobuf::internal::ExtensionSet::RegisterMessageExtension(
    &::Eaagles::Recorder::Pb::DataRecord::default_instance(),
    1000, 11, false, false,
    &::Eaagles::xDataRecorder::Pb::MyDataMsg::default_instance());
  ::google::protobuf::internal::ExtensionSet::RegisterExtension(
    &::Eaagles::Recorder::Pb::MarkerMsg::default_instance(),
    100, 13, false, false);
  MyDataMsg::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_xDataRecorder_2fDataRecord_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_xDataRecorder_2fDataRecord_2eproto {
  StaticDescriptorInitializer_xDataRecorder_2fDataRecord_2eproto() {
    protobuf_AddDesc_xDataRecorder_2fDataRecord_2eproto();
  }
} static_descriptor_initializer_xDataRecorder_2fDataRecord_2eproto_;
...
const MyDataMsg& MyDataMsg::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_xDataRecorder_2fDataRecord_2eproto();  return *default_instance_;
}
...
::google::protobuf::internal::ExtensionIdentifier< ::Eaagles::Recorder::Pb::DataRecord,
    ::google::protobuf::internal::MessageTypeTraits< ::Eaagles::xDataRecorder::Pb::MyDataMsg >, 11, false >
  my_data_msg(kMyDataMsgFieldNumber, ::Eaagles::xDataRecorder::Pb::MyDataMsg::default_instance());
